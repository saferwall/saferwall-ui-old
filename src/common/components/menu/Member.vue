<template >
  <div
    v-if="getUser"
    class="btn-menu btn-border profile-menu"
    tabindex="4"
    @focusout="menuDisplay = false"
  >
      ...
      <drop-menu :display="menuDisplay">
        <a @click="$router.push('/profile')" class="dropmenu-item">
          <svg
            ...
            width="15.654"
            height="17.789"
            viewBox="0 0 15.654 17.789"
          >
            <g transform="translate(3.558)">
              <path
                d="M13.269,15.039A4.193,4.193,0,0,1,9,10.769,4.193,4.193,0,0,1,13.269,6.5a4.193,4.193,0,0,1,4.269,4.269A4.193,4.193,0,0,1,13.269,15.039Zm0-7.116a2.846,2.846,0,1,0,2.846,2.846A2.855,2.855,0,0,0,13.269,7.923Z"
                transform="translate(-9 -6.5)"
              />
            </g>
            <g transform="translate(0 10.673)">
              <path
                d="M21.443,21.116a.672.672,0,0,1-.712-.712V17.558A2.189,2.189,0,0,0,18.6,15.423H10.058a2.189,2.189,0,0,0-2.135,2.135V20.4a.672.672,0,0,1-.712.712A.672.672,0,0,1,6.5,20.4V17.558A3.523,3.523,0,0,1,10.058,14H18.6a3.523,3.523,0,0,1,3.558,3.558V20.4A.672.672,0,0,1,21.443,21.116Z"
