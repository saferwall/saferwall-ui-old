  ...
  <div class="auth-card">
    ...
    <form method="POST" class="w-full" @submit="formSubmited">
      <div class="header flex my-3">
        ...
        >
          <g id="add-user" transform="translate(0)" style="isolation: isolate">
            ...
            <g transform="translate(26.39 26.389)">
              <path
                d="M335.932,328.147h-4.507v-4.507a1.639,1.639,0,1,0-3.278,0v4.507h-4.507a1.639,1.639,0,1,0,0,3.278h4.507v4.507a1.639,1.639,0,0,0,3.278,0v-4.507h4.507a1.639,1.639,0,0,0,0-3.278Z"
        ...
        <h2 class="title text-3xl font-semibold">Sign Up</h2>
      </div>
      <div class="content mt-8">
        ...
        <div class="form-group justify-center pt-3">
          ...
          <router-link class="text-primary font-bold mx-2" to="/auth/login"
            >Login</router-link
          >
        </div>
      </div>
