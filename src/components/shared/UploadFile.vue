        ...
        <div class="upload">
            <button class="btn-upload btn-disabled">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" class="ml-4" width="33.303" height="25.533" viewBox="0 0 33.303 25.533">
                    <g id="cloud-computing" style="isolation: isolate">
                        <g id="Groupe_2" data-name="Groupe 2" transform="translate(0 0)">
                        <g id="Groupe_1" data-name="Groupe 1">
                            <path id="Tracé_1" data-name="Tracé 1" d="M27.748,63.462A11.472,11.472,0,0,0,13.858,55.37a11.227,11.227,0,0,0-8.63,10A6.1,6.1,0,0,0,.084,72.349a6.2,6.2,0,0,0,6.185,5.087h5.2V75.411h-5.2a4.052,4.052,0,1,1,0-8.1A1.027,1.027,0,0,0,7.31,66.3a9.242,9.242,0,0,1,9.356-9.123,9.3,9.3,0,0,1,9.2,7.351,1.029,1.029,0,0,0,.885.81,5.088,5.088,0,0,1,4.418,5.726,5.159,5.159,0,0,1-5.125,4.349H21.879v2.025h4.162a7.071,7.071,0,0,0,1.707-13.974Z" transform="translate(0 -55.032)" fill="#fff"/>
                            <path id="Tracé_2" data-name="Tracé 2" d="M185.206,249.314l-4.171,4.171,1.47,1.47,2.4-2.388v10h2.086v-10l2.388,2.388,1.47-1.47-4.171-4.171A1.043,1.043,0,0,0,185.206,249.314Z" transform="translate(-169.271 -237.036)" fill="#fff"/>
                        </g>
                        </g>
                    </g>
                </svg>
