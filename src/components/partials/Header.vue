<template>
<nav class="navbar bg-white fixed w-full top-0">
    <div class="mx-auto flex h-full flex-wrap ">

        <div class="logo md:px-6 px-5 flex justify-center md:justify-start text-black font-extrabold">
        ...
        <div class="flex items-center w-full h-full ml-auto content-center w-max sm:justify-end ">
            <div class="lg:flex lg:items-stretch lg:justify-end h-full">
...
.navbar {
    ...
    .btn-menu {
        @apply  relative py-2 px-4 leading-normal text-black no-underline flex items-center hover:bg-gray-300 ;
